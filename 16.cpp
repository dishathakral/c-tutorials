...
public:
    ...
    void bill() {
        ...
        for (int i = 0; i < MAX_ITEMS; ++i) {
            cout << "Name: " << itemNames[i] << ", Price: " << itemPrices[i] << ", Item code: " << itemcode[i] << ", Quantity: " << itemQuantities[i] << endl;
        }
        int n;
        ...
        cout << "\nRemaining quantities after purchase:\n";
        for (int i = 0; i < MAX_ITEMS; ++i) {
            cout << "Name: " << itemNames[i] << ", Remaining quantity: " << itemQuantities[i] << endl;
        }
    }
};
